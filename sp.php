  ...
  <div class="hero-content display-table">
    <div class="table-cell">
      <div class="container">
        ...
        <h1 class="hero-title mb-4">Situations Professionnelles</h1>
        <p class="hero-subtitle"><span class="typed" data-typed-items="Mes Situations Professionnelles"></span></p>
...
<div class="row certif">
  <div class="col-md-4 img-aws">
    <div class="flex-woaw">
      ...
      <div class="pdf">
        <embed src="assets/AWS_Academy_Graduate___AWS_Academy_Cloud_Foundations_Badge20240120-34-lccg3u.pdf"
