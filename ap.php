    ...
    <div class="hero-content display-table">
        <div class="table-cell">
            <div class="container">
                ...
                <h1 class="hero-title mb-4">Ateliers de Professionnalisation</h1>
                <p class="hero-subtitle"><span class="typed" data-typed-items="Mes Documentations, Mes Ateliers"></span></p>
